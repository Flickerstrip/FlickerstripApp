...
def receivedTcpPacket(info):
    ...
    if (cmdName == "GET_PATTERNS"):
        json = '{"type":"status","power":0,"firmware":"v0.0.0","patterns":[{"name":"PatternFoo","address":768,"length":2,"frame":2,"flags":0,"fps":1}],"selectedPattern":5,"brightness":50,"memory":{"used":100,"free":100,"total":100}}\n\n';
