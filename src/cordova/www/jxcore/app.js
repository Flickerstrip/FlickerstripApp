...
Mobile("guiReady").registerAsync(function(json) {
    //require('os').tmpdir()
    var config = new Configuration(path.join(process.userPath,"config.json"),path.join(process.userPath,"firmwareVersions"),path.join(process.userPath,"patterns"),path.join(__dirname,"patterns"));
    try {
